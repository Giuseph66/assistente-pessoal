        ...
        <div className="session-layout">
            ...
            <header className="session-header">
                ...
                <div className="header-actions">
                    ...
                    <button className="icon-btn settings-btn" onClick={() => (window as any).electron.ipcRenderer.send('window:open-settings')}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    ...
                    <button className="icon-btn minimize-btn" onClick={() => (window as any).electron.ipcRenderer.send('window:minimize')}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            <line x1="5" y1="12" x2="19" y2="12" />
                        </svg>
                    </button>
                    <button className="icon-btn close-btn" onClick={() => (window as any).electron.ipcRenderer.send('window:close')}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                {!isSessionActive ? (
                    <div className="empty-session-view">
                        ...
                        <div className="action-list">
                            ...
                            <button className="action-item" onClick={() => (window as any).electron.ipcRenderer.send('window:open-command-bar')}>
                                <div className="action-item-left">
                                    <div className="action-item-icon">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
